...
## Installation
    ...
    meteor add mrspark:vue-router2
...
import { RouterFactory, nativeScrollBehavior } from 'meteor/mrspark:vue-router2'
...
// Import the router
import { RouterFactory } from 'meteor/mrspark:vue-router';
